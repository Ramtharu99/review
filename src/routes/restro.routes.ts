...
import * as RestaurantController from '../controllers/restro.controller'
...
import { createRestaurantDto, updateRestaurantDto } from '../validators/create-restro.validator'
